...
def list_apps_with_details():
    ...
    username = input("> Nom d'utilisateur SSH (généralement 'root') : ")
    ...
    try:
        ...
        for uuid in bundle_uuids:
            ...
            if app_folder:
                ...
                final_data_path = matched_data_path if matched_data_path else "?**? Non trouvé"
        ...
        for i, app in enumerate(app_list):
            ...
            print(f"     📁 Binaire : {app['binary_path']}")
            print(f"     📂 Données : {app['data_path']}\n")
